...
! ===========================================================================
     ...
     3       'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr', 'Rb', 'Sr',
     4       'Y ', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd',
     5       'In', 'Sn', 'Sb', 'Te', 'I ', 'Xe', 'Cs', 'Ba', 'La', 'Ce',
     6       'Pr', 'Nd', 'Pm', 'Sm', 'Eu', 'Gd', 'Tb', 'Dy', 'Ho', 'Er',
     7       'Tm', 'Yb', 'Lu', 'Hf', 'Ta', 'W ', 'Re', 'Os', 'Ir', 'Pt',
     8       'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn', 'Fr', 'Ra',
     9       'Ac', 'Th', 'Pa', 'U ', 'Np', 'Pu', 'Am', 'Cm', 'Bk', 'Cf',
     1       'Es', 'Fm', 'Md', 'No', 'Lw' /
...
! ===========================================================================
        ...
        character*2 atomcheck
 
        character*15 inputfile (nspec_max)
...
! Check that xns + xnp .lt. nzx
         ...
         if (add .gt. nzx(ispec)) then
          write (*,*) ' xnocc = ',
     1                 (xnocc(issh,ispec), issh = 1, nssh(ispec))
...
! Set up the useful Angstrom array rcutoffa, and what.
     ...
     1    (rcutoffa(ispec,issh), issh = 1, nssh(ispec))
        end do
