...
! Input 
        ...
        real*8, intent (in) :: dbc  ! maximum bond distance: rc1 + rc2
        real*8, intent (in) :: dna  ! maximum neutral atom distance: 2*rc3
        real*8, intent (in) :: rcutoff1  ! largest radius of i-th atom (in Ang.)
        real*8, intent (in) :: rcutoff2  ! 1, 2, 3 = left, right, neutral atom
        real*8, intent (in) :: rcutoff3

        real*8, intent (in), dimension (ntheta_max) :: ctheta
        real*8, intent (in), dimension (ntheta_max) :: ctheta_weights
...
! ===========================================================================
        ...
        real*8, dimension (ntheta_max) :: answer
! Final results after sin(theta) or cos(theta) factor.
        real*8, dimension (0:10, inter_max, ntheta_max) :: ggstore
! Results from the integrator
        real*8, dimension (0:10, inter_max) :: gmat
        real*8, dimension (ntheta_max, inter_max, 0:10) :: qpl
